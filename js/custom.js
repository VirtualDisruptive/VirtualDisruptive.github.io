...
function mainmenu() {
    ...
    if ($('.main-menu li.dropdown ul').length) {
        ...
        $('.main-menu li.dropdown a').on('click', function() {
            ...
            $(this).parent().find('.dropdown-btn').prev('ul').slideToggle(500);
...
function stickyHeader() {
    ...
    if ($('.stricky').length) {
        ...
        var strickyScrollPos = 20;

        if ($(window).scrollTop() > strickyScrollPos) {

            // $('.stricky').addClass('stricky-fixed');

            $('.stricky').addClass('sticko');
        ...
        ******************************************************************/
            ...
            $(window).on('scroll', function() {
                ...
                heroTitle.css({ 
                    ...
                    'transform' : "translate3d(0px,"+(st/2.25)+"px, 0px)",
...
$(document).on('click', 'a[href^="#"]', function(e) {
    ...
    $('.main-menu .navigation li').removeClass('current');
